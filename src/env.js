...
export const env = createEnv({
	...
	runtimeEnv: {
		...
		BETTER_AUTH_MICROSOFT_CLIENT_ID: process.env.BETTER_AUTH_MICROSOFT_CLIENT_ID,
		BETTER_AUTH_MICROSOFT_CLIENT_SECRET: process.env.BETTER_AUTH_MICROSOFT_CLIENT_SECRET,
		BETTER_AUTH_MICROSOFT_TENANT_ID: process.env.BETTER_AUTH_MICROSOFT_TENANT_ID,
