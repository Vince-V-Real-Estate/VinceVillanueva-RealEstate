...
import {MAX_FEATURED_LISTINGS, formatBathroomCount, formatFeaturedListingPrice, type FeaturedListing, type FeaturedListingMutationInput} from "@/lib/featured-listings/types";
				...
				<div className="overflow-hidden rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6">
					...
					>
						...
						<div className="flex flex-wrap gap-2">
							<Button
								type="submit"
								disabled={isMutating || isUploadingImage || (!editingId && !canCreateMore && listings.length > 0)}
							>
								{isPending ? (
									<>
										<Loader2 className="h-4 w-4 animate-spin" />
