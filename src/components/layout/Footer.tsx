		...
		<footer className="bg-muted py-12 md:py-16 lg:py-24">
			<div className="container mx-auto px-4 md:px-6">
				<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
					<div className="space-y-4">
						...
						<div className="text-muted-foreground flex flex-col space-y-1 text-sm">
							<p>Phone: 604-339-1313</p>
							<p>Email: v.villanueva@ymail.com</p>
						</div>
					</div>
					<div className="space-y-4">
				...
				<div className="text-muted-foreground mt-12 space-y-4 text-xs">
					<p>
						The data relating to real estate on this website comes in part from the MLS® Reciprocity program of either the Greater Vancouver REALTORS® (GVR), the Fraser Valley Real Estate Board (FVREB) or the Chilliwack and District Real
						Estate Board (CADREB). This representation is based in whole or part on data generated by either the GVR, the FVREB or the CADREB which assumes no responsibility for its accuracy. The materials contained on this page may not
						be reproduced without the express written consent of either the GVR, the FVREB or the CADREB.
					</p>
