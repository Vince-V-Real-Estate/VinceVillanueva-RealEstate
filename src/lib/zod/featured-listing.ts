...
export const updateFeaturedListingInputSchema = featuredListingInputSchema.partial().refine((value) => Object.keys(value).length > 0, {
	message: "Provide at least one field to update",
});

export type FeaturedListingInput = z.infer<typeof featuredListingInputSchema>;
export type UpdateFeaturedListingInput = z.infer<typeof updateFeaturedListingInputSchema>;
