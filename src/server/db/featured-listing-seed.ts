...
const DUMMY_LISTINGS = [
	{
		...
		description: "Bright corner condo with floor-to-ceiling windows, open living spaces, and quick access to shops, transit, and waterfront trails.",
	...
	},
	{
		...
		description: "Spacious family home featuring a large backyard, updated kitchen, and flexible rooms ideal for growing households and home offices.",
