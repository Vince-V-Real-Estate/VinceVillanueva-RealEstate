				...
				<div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
					<div className="flex items-center justify-between">
						<div>
							...
							<p className="mt-1 text-sm text-gray-500">Manage your leads and website content</p>
						</div>
							...
							<NavigationMenuList className="flex w-full flex-row">
								<NavigationMenuItem>
									<button
										...
										className={cn(navigationMenuTriggerStyle(), "cursor-pointer bg-transparent shadow-none hover:bg-gray-100 data-[state=open]:bg-transparent", activeTab === "leads" && "bg-gray-100 font-semibold")}
									>
										Leads Management
									</button>
								</NavigationMenuItem>
								<NavigationMenuItem>
									<button
										...
										className={cn(navigationMenuTriggerStyle(), "cursor-pointer bg-transparent shadow-none hover:bg-gray-100 data-[state=open]:bg-transparent", activeTab === "listings" && "bg-gray-100 font-semibold")}
									>
										Featured Listings
									</button>
								</NavigationMenuItem>
